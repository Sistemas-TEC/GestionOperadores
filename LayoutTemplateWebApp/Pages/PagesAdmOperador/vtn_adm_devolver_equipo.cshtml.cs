...
namespace LayoutTemplateWebApp.Pages.PagesAdmOperador
{
    public class vtn_adm_devolver_equipoModel : PageModel
    {
        ...
        public vtn_adm_devolver_equipoModel(GestionOperatorsContext gestionOperatorsContext)
        {
        ...
        public async Task<IActionResult> OnPostDevolverEquipo()  // Cambio de nombre
        {
            try
            {
                ...
                TempData["SuccessMessage"] = "Equipo devuelto exitosamente";  // Correcci�n de mensaje
