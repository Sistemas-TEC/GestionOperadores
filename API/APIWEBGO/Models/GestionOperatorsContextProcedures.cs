...
namespace APIWEBGO.Models
{
    ...
    public partial class GestionOperatorsContextProcedures : IGestionOperatorsContextProcedures
    {
        ...
        public virtual async Task<int> UpdateOperatorAsync(int? idOperator, string cellphone, string email, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[UpdateOperator] @idOperator, @cellphone, @email", sqlParameters, cancellationToken);
